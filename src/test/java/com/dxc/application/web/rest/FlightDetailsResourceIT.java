...
import com.dxc.application.FlightservicesApp;
 ...
 */
@SpringBootTest(classes = FlightservicesApp.class)
public class FlightDetailsResourceIT {
    ...
    public void createFlightDetails() throws Exception {
        ...
        assertThat(testFlightDetails.getCreatedTime()).isEqualTo(DEFAULT_CREATED_TIME);
    }
    ...
    public void updateFlightDetails() throws Exception {
        ...
        assertThat(testFlightDetails.getCreatedTime()).isEqualTo(UPDATED_CREATED_TIME);
    }
